...
Функция гСформироватьСписокТипов(СтруктураКЭШ = Неопределено, СписокДобавленныхТипов = Неопределено) Экспорт
	...
	// Добавление типов из расширения для режима совместимости до 8.3.20
	Для каждого ОбъектМетаданных Из Метаданные.Документы Цикл
		Тип = Тип("ДокументСсылка." + ОбъектМетаданных.Имя);
		Если МассивТипов.Найти(Тип) = Неопределено Тогда
			МассивТипов.Добавить(Тип);
		КонецЕсли;
	КонецЦикла;
	Для каждого ОбъектМетаданных Из Метаданные.Справочники Цикл
		Тип = Тип("СправочникСсылка." + ОбъектМетаданных.Имя);
		Если МассивТипов.Найти(Тип) = Неопределено Тогда
			МассивТипов.Добавить(Тип);
		КонецЕсли;
	КонецЦикла;
	Для каждого ОбъектМетаданных Из Метаданные.Перечисления Цикл
		Тип = Тип("ПеречислениеСсылка." + ОбъектМетаданных.Имя);
		Если МассивТипов.Найти(Тип) = Неопределено Тогда
			МассивТипов.Добавить(Тип);
		КонецЕсли;
	КонецЦикла;
	Для каждого ОбъектМетаданных Из Метаданные.ПланыВидовХарактеристик Цикл
		Тип = Тип("ПланВидовХарактеристикСсылка." + ОбъектМетаданных.Имя);
		Если МассивТипов.Найти(Тип) = Неопределено Тогда
			МассивТипов.Добавить(Тип);
		КонецЕсли;
	КонецЦикла;
	Для каждого ОбъектМетаданных Из Метаданные.ПланыВидовРасчета Цикл
		Тип = Тип("ПланВидовРасчетаСсылка." + ОбъектМетаданных.Имя);
		Если МассивТипов.Найти(Тип) = Неопределено Тогда
			МассивТипов.Добавить(Тип);
		КонецЕсли;
	КонецЦикла;
	Для каждого ОбъектМетаданных Из Метаданные.ПланыСчетов Цикл
		Тип = Тип("ПланСчетовСсылка." + ОбъектМетаданных.Имя);
		Если МассивТипов.Найти(Тип) = Неопределено Тогда
			МассивТипов.Добавить(Тип);
		КонецЕсли;
	КонецЦикла;
	Для каждого ОбъектМетаданных Из Метаданные.БизнесПроцессы Цикл
		Тип = Тип("БизнесПроцессСсылка." + ОбъектМетаданных.Имя);
		Если МассивТипов.Найти(Тип) = Неопределено Тогда
			МассивТипов.Добавить(Тип);
		КонецЕсли;
	КонецЦикла;
	Для каждого ОбъектМетаданных Из Метаданные.Задачи Цикл
		Тип = Тип("ЗадачаСсылка." + ОбъектМетаданных.Имя);
		Если МассивТипов.Найти(Тип) = Неопределено Тогда
			МассивТипов.Добавить(Тип);
		КонецЕсли;
	КонецЦикла;
